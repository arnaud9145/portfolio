...
export const en: CvContent = {
  ...
  projects: [
    { id: "unlockt", name: "Unlockt", context: "Unlockt.me", role: "Senior Mobile Engineer", contribution: "major", tagline: "Creators selling their files.", metrics: ["1.2M active users"], link: { href: "https://apps.apple.com/us/app/unlockt-sell-your-files/id1632025425", label: "App Store" } },
    { id: "exposed", name: "Exposed", context: "Behind The App", role: "Mobile Engineer", contribution: "major", tagline: "\"Who's Most Likely To\" party game (5000+ prompts, 4 modes).", metrics: ["~500k users/month"], link: { href: "https://apps.apple.com/us/app/exposed-whos-most-likely-to/id1553777064", label: "App Store" } },
    { id: "disorder", name: "Disorder", context: "Behind The App", role: "Mobile Engineer", contribution: "major", tagline: "Social app: weekly group chats with strangers nearby (50/50 mixed groups).", metrics: [], link: { href: "https://apps.apple.com/us/app/disorder-talk-meet-repeat/id6738487787", label: "App Store" } },
    { id: "movizer", name: "Movizer", context: "Happliness", role: "CTO & co-founder", contribution: "lead", tagline: "Personalised movie & series recommendations, shared with friends.", metrics: [], link: { href: "https://lespepitestech.com/startup-de-la-french-tech/movizer", label: "Les Pépites Tech" }, status: "Removed (2024)" },
    ...
    { id: "konectom", name: "Konectom", context: "BAM — Biogen client", role: "Mobile Engineer", contribution: "minor", tagline: LOREM_TAGLINE, metrics: [] },
    { id: "rift", name: "Rift", context: "BAM — formerly More Impact", role: "Mobile Engineer", contribution: "minor", tagline: LOREM_TAGLINE, metrics: [] },
    ...
    { id: "gala-utt", name: "Gala UTT", context: "UNG — UTT Net Group", role: "Developer", contribution: "major", tagline: LOREM_TAGLINE, metrics: [] },
    { id: "my-utt", name: "My UTT", context: "UNG — UTT Net Group", role: "Developer", contribution: "major", tagline: LOREM_TAGLINE, metrics: [] },
    { id: "integration-utt", name: "Intégration UTT", context: "UNG — UTT Net Group", role: "Developer", contribution: "major", tagline: LOREM_TAGLINE, metrics: [] },
    { id: "bde-utt", name: "BDE UTT", context: "UNG — UTT Net Group", role: "Developer", contribution: "major", tagline: LOREM_TAGLINE, metrics: [] },
  ],
  experience: [
    ...
    { id: "ung", company: "UNG (UTT Net Group)", role: "Developer & President", period: "2016 → 2019", summary: "", highlights: LOREM_MISSIONS, companyUrl: "#", appTags: [{ label: "Gala UTT", projectId: "gala-utt" }, { label: "My UTT", projectId: "my-utt" }, { label: "Intégration UTT", projectId: "integration-utt" }, { label: "BDE UTT", projectId: "bde-utt" }] },
  ],
  stack: [
